...
export default function ItemCard({ item }: ItemCardProps) {
  return (
    <article 
      className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow focus-within:ring-2 focus-within:ring-green-500 focus-within:ring-offset-2"
      role="article"
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link
            href={`/items/${item.id}`}
            className="text-green-600 hover:text-green-800 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 rounded-lg px-3 py-1 hover:bg-green-50 transition-all duration-200"
