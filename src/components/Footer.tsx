        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              J&R Games - We buy your gaming items! Get cash for your consoles, games, and accessories. 
              Fair prices, quick transactions, trusted service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/condition-guide" className="text-gray-300 hover:text-blue-300 transition-colors">
                  Condition Guide
                </Link>
              </li>
              <li>
                <Link href="/scan" className="text-gray-300 hover:text-green-300 transition-colors">
                  Scan Barcode
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} J&R Games. All rights reserved.
            </p>
